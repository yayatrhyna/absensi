        ...
        <div class="container-fluid py-3">
          ...
          <a href="<?= base_url('master/users'); ?>" class="btn btn-danger bg-gradient-danger border btn-icon-split mb-4 rounded-0">
            ...
            <div class="col-lg-5 p-0">
              <form action="<?= base_url('master/a_users/') . $e_id; ?>" method="POST">
                <div class="card rouded-0">
                  <h5 class="card-header">Master data User</h5>
                  <div class="card-body">
                    <h5 class="card-title">Tambah User Baru</h5>
                    <p class="card-text">Formulir untuk menambahkan pengguna baru ke sistem</p>
