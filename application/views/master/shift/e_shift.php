        ...
        <div class="container-fluid mb-3">
          ...
          <a href="<?= base_url('master/shift'); ?>" class="btn btn-danger bg-gradient-danger border btn-icon-split mb-4 rounded-0">
          ...
          <div class="row justify-content-center">
            <form action="" method="POST" class="col-lg-5  p-0">
              <div class="card rounded-0">
                <h5 class="card-header">Shift Data Master</h5>
                <div class="card-body">
                  <?= $this->session->flashdata('message') ?>
                  <h5 class="card-title">Edit Shift</h5>
                  <p class="card-text">Formulir untuk mengedit shift di sistem</p>
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label col-form-label-lg">Nomer Shift</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="s_end_h" class="col-form-label-lg">Waktu selesai Shift</label>
                    <div class="row">
                      <div class="col-sm-4">
