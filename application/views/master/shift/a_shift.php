          ...
          <div class="row justify-content-center">
            <form action="" method="POST" class="col-lg-5 col-md-6 col-sm-12 col-xs-12 p-0">
              <div class="card rounded-0">
                <h5 class="card-header">Master Data Shift</h5>
                <div class="card-body">
                  <?= $this->session->flashdata('message') ?>
                  <h5 class="card-title">Tambah Shift Baru</h5>
                  <p class="card-text">Formulir untuk menambahkan shift baru ke sistem</p>
                  ...
                  <div class="form-group">
                    <label for="s_start_h" class="col-form-label-lg">Mulai SHift</label>
                    <div class="row">
                      <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label for="s_end_h" class="col-form-label-lg">Selesai Shift</label>
                    <div class="row">
                      <div class="col-sm-4">
