        ...
        <div class="container-fluid">
          ...
          <a href="<?= base_url('master/location'); ?>" class="btn btn-primary bg-gradient-primary border btn-icon-split mb-4 rounded-0">
          ...
          <div class="row justify-content-center">
            <form action="" method="POST" class="col-lg-5 col-md-6 col-sm-12 col-xs-12 p-0">
              <div class="card rounded-0">
                <h5 class="card-header">Data Induk Posisi</h5>
                <div class="card-body">
                  <?= $this->session->flashdata('message') ?>
                  <h5 class="card-title">Edit POsisi</h5>
                  <p class="card-text">Formulir untuk menambahkan Posisi baru ke sistem</p>
                  <div class="form-group">
                    <label class="col-form-label-lg">ID Posisi</label>
                    <input type="text" readonly class="form-control-plaintext form-control-lg" name="l_id" value="<?= $l_old['id']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="l_name" class="col-form-label-lg">Nama Posisi</label>
